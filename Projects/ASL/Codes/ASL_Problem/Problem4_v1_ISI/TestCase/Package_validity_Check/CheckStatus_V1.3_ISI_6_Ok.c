/***Bug is at line no.-72,  assertions for Package Validity Fail***/
/*****************************************************************************/
...
void  CheckStatus()
{
	...
	if (((TimeoutFlag == 1) || (HeaderValidFlag == 1) || (chksumValidFlag == 0) || (DataValid == 0)) && ((mode_word == 11) || (mode_word == 44)))
	{
		for (i = 0; i<3; i++)
		{
