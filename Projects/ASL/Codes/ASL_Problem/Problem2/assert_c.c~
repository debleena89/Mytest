...
void verifDc_Dc(__CPROVER_bool MainDC_DC, __CPROVER_bool StdbyDC_DC, int verifchno)
{
    __CPROVER_bool OK[8];
...
{
    __CPROVER_bool MainDC_DC; // changed bool to  __CPROVER_bool
    __CPROVER_bool StdbyDC_DC; // changed bool to  __CPROVER_bool
    ...
    verifDc_Dc(MainDC_DC, StdbyDC_DC, dip); // calling the verif function
}
