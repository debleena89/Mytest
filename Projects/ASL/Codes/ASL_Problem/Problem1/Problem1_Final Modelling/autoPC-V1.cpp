...
int main () 
{
    ...
    /* Assert on Count of Oks */

    __CPROVER_assert (countOfOks <= 1, "More OKs satisfied than usual");
    __CPROVER_assert (countOfNOks <= 1, "More NOKs satisfied than usual");

    /* Mutex on OK and NOK pairwise */
    __CPROVER_assert (!OK[0] || !NOK[0], "OK and NOK are pairwise exclusive");
    __CPROVER_assert (!OK[1] || !NOK[1], "OK and NOK are pairwise exclusive");
    __CPROVER_assert (!OK[2] || !NOK[2], "OK and NOK are pairwise exclusive");
    __CPROVER_assert (!OK[3] || !NOK[3], "OK and NOK are pairwise exclusive");
    __CPROVER_assert (!OK[4] || !NOK[4], "OK and NOK are pairwise exclusive");
    __CPROVER_assert (!OK[5] || !NOK[5], "OK and NOK are pairwise exclusive");
