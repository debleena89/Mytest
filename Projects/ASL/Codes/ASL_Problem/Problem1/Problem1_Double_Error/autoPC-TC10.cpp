/* Negative Test Case 10, 0K3, OK5, NOK2,NOK6 and NOK4 failed */
...
bool get_dmr_status(unsigned char chnum, bool on_off)
{
    ...
    /////////////detect output///////////////////////
    if((!No_liu1_data && !liu1_notok) || (!No_liu2_data && !liu2_notok)) // Bug Inserted
    {
        ...
        output_undef = false;// Bug introduced here for double error
